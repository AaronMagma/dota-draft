...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Дополнительный запуск: будим ИИ-бота через полсекунды
...
// Блокируем выбор игрока, если сейчас ход компьютера (Dire)
...
selectedHeroId = null;
updateUI();
// Передаем управление боту с минимальной задержкой
...
// Если сейчас ходит ИИ (Dire), кнопка блокируется
if (turn.team === "dire") {
...
// Логика автоматического выбора для компьютерного бота (Dire)
...
// Бот выдерживает паузу и фиксирует свой выбор
setTimeout(() => {
